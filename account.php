    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="analysis.php"></a>Performance Analysis</li>
        ...
        <div class="main-content">
            <div class="header">
                <a href="dashboard.php"><h1>My Account</h1> </a>
                <button class="logout-btn" onclick="window.location.href='logout.php'">Logout</button>
            </div>
            <div class="content">
                <div class="toggle-container">
                    <button class="toggle-btn toggle-btn-light" onclick="toggleMode()">Toggle Light/Dark Mode</button>
                </div>
