...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_result->num_rows > 0) {
        echo '<h1 style="text-align:center; ont-weight: bold; position: absolute; color: blue; top: 10%; left: 50%; transform: translate(-50%, -50%)">Username or email already exists. Please choose a different one.</h1>';
        echo '<ul style="text-align: center; position: absolute; top: 20%; left: 50%; transform: translateX(-50%);">';
